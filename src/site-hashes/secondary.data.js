...
async function fetchSecondaryData(base) {
  const url = `${base}/selfservice/api/SelfServiceSecondaryData/GlobalSearchSecondaryData`;
  ...
  try {
    ...
    const filePath = path.join(dirPath, "secondary.data.json");
...
module.exports = { fetchSecondaryData };
